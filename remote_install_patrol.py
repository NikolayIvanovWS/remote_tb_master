...
def install_to_one_tb(host, username, passwd):
    ...
    build_pkg = "catkin_make --pkg=turtlebro_patrol"

    stdin, stdout, stderr = client.exec_command("cd /home/pi/catkin_ws/src &&"
    ...
    stdin, stdout, stderr = client.exec_command("source /opt/ros/noetic/setup.bash;" +
                                                "cd ~/catkin_ws/;" +
